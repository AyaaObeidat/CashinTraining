namespace BookBorrowingLibrary.Models
{
    public class Book
    {
        ...
        private Book() { }
        private Book(string title, string author, string publisher, string publicationYear, int numberOfAvailableCopies, int totalNumberOfCopies)
        {
        ...
        public static Book Create(string title, string author, string publisher, string publicationYear, int numberOfAvailableCopies, int totalNumberOfCopies)
        {
            ...
            return new Book(title, author, publisher, publicationYear, numberOfAvailableCopies, totalNumberOfCopies);
